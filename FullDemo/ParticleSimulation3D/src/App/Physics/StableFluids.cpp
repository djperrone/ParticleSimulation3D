...
namespace Physics {
    ...
    /* To use:
    *  Call FluidCubeAddDensity and FluidCubeAddVelocity to drop some "dye" into specified location
    *  Then call FluidCubeStep repeatedly to simulate the diffusion, projection, and advection
    */
    void RunDemo(FluidCube* cube)
    {
        int N = 10;

       // std::cout << cube->Vx[IX(64, 64, 64)] << std::endl;

        spdlog::info(cube->Vx[IX(8, 8, 8)]);
    ...
    {
        FluidCubeAddDensity(cube, 8, 8, 8, 50);
        FluidCubeAddVelocity(cube, 8, 8, 8, .3, .2, .4);
    }
