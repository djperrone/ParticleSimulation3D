...
#include "Novaura/Camera/Perspective/PerspectiveCamera.h"
...
namespace Novaura {
	...
	public:
		...
		PerspectiveCamera& GetCameraController() { return *m_Camera; }
		const PerspectiveCamera& GetCameraController() const { return *m_Camera; }
		...
		void SetCamera(std::shared_ptr<PerspectiveCamera> cameraController) { m_Camera = cameraController; }
